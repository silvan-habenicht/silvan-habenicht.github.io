...
<p class="note">
    Hinweis: <code> java.util.Observer </code> und <code> java.util.Observable </code> sind inzwischen <em>depracated</em> und sollten nicht mehr verwendet werden. Die <a target="blank" href="https://docs.oracle.com/javase/9/docs/api/java/util/Observable.html">Begründung von Oracle</a> macht deutlich, dass das Observer-Pattern auch als ein <em>Antipattern</em> betrachtet werden kann.
</p>
